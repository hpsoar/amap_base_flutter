...
class CircleOptions {
  ...
  @override
  String toString() {
    return 'CircleOptions{center: $center, radius: $radius, color: $color, zIndex: $zIndex, isVisible: $isVisible, isDottedLine: $isDottedLine, isGeodesic: $isGeodesic, dottedLineType: $dottedLineType, lineCapType: $lineCapType, lineJoinType: $lineJoinType, isUseGradient: $isUseGradient, isUseTexture: $isUseTexture}';
  }
}